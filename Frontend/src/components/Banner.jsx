...
const Banner = () => {
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col gap-16 md:flex-row my-10">
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36 ">
          ...
          <button className="btn btn-secondary mt-6 px-10 text-lg">
            Get Started
          </button>
        </div>
